...
function AuctionatorConfigTooltipsFrameMixin:OnShow()
  ...
  self.DetailsEnchantTooltips:SetValue(tostring(Auctionator.Config.Get(Auctionator.Config.Options.DETAILS_ENCHANT_TOOLTIPS)))
...
function AuctionatorConfigTooltipsFrameMixin:Save()
  ...
  Auctionator.Config.Set(Auctionator.Config.Options.DETAILS_ENCHANT_TOOLTIPS, tonumber(self.DetailsEnchantTooltips:GetValue()))
