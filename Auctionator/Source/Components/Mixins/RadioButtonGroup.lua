...
function AuctionatorConfigRadioButtonGroupMixin:InitializeRadioButtonGroup()
  ...
  local groupHeadingText = self:GetAttribute("groupHeadingText")
  groupHeadingText = _G[groupHeadingText] or groupHeadingText

  if groupHeadingText ~= nil then
    self.GroupHeading:SetAttribute("subHeadingText", groupHeadingText)
